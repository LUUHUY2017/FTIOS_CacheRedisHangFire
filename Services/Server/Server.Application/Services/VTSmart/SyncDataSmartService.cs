...
public sealed class SyncDataSmartService
{
    ...
    public async Task<List<GradeClasseReponse>> PostAttendence()
    {
    ...
    public static string GetSecretKey(string secretKey, string keyHas, string ivHas, string schoolCode)
    {
