...
public class LoginWith2faModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync(bool rememberMe, string returnUrl = null)
    {
        ...
        if (result.Succeeded)
        {
            Logger.Information(string.Format("User with ID '{UserId}' logged in with 2fa.", user.Id));
        ...
        {
            Logger.Information(string.Format("Invalid authenticator code entered for user with ID '{UserId}'.", user.Id));
