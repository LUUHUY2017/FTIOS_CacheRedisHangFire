...
namespace Server.Infrastructure.Datas.MasterData.MySqlMigrations
{
    ...
    [Migration("20241016044559_MasterData_InitAddLane")]
    partial class MasterData_InitAddLane
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Core.Entities.A0.A0_Person", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("Server.Core.Entities.A0.A0_PersonType", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("Server.Core.Entities.GIO.GIO_VehicleInOut", b =>
                {
                    ...
                    b.Property<Guid?>("UserInId")
                        .HasColumnType("char(36)");

                    b.Property<Guid?>("UserOutId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Server.Core.Entities.A0.A0_Person", b =>
                {
                    b.HasOne("Server.Core.Entities.A0.A0_PersonType", "PersonType")
                        .WithMany()
